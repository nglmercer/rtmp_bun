...
describe("RTMP Handshake Module", () => {
  ...
  describe("RtmpHandshake Class", () => {
    ...
    describe("generateC1", () => {
      ...
      it("should include timestamp in first 4 bytes", () => {
        ...
        // Timestamp is stored as 32-bit unsigned integer (mod 2^32)
        const beforeTimestamp = beforeTime % 0x100000000;
        const afterTimestamp = afterTime % 0x100000000;
    ...
    describe("generateC2", () => {
      ...
      it("should generate C2 using server S1", () => {
        ...
        expect(clientHandshake.getState()).toBe("completed");
      });
  ...
  describe("RtmpServerHandshake Class", () => {
    ...
    describe("generateServerResponse", () => {
      ...
      it("should extract client timestamp from client C1", () => {
        ...
        const digest = createDigest(c1.subarray(0, 1535));
        digest.copy(c1, 1535);
  ...
  describe("performHandshakeSimulation", () => {
    ...
    it("should timeout with hanging client handshake", async () => {
      ...
      try {
        ...
        expect(error.message).toBe("Simulated hang");
      }
  ...
  describe("Edge Cases", () => {
    it("should handle rapid state transitions", () => {
      ...
      expect(handshake.getState()).toBe("completed");
    });
